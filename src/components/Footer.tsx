...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-900 py-12 dark:bg-dark-950">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">

          <div>
            <div className="mb-4 font-mono text-xl font-bold">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-dark-400 transition-colors hover:text-primary-400"
                aria-label="GitHub"
              >
              ...
              <a
                href="https://linkedin.com/in/nurulfaradila"
                target="_blank"
                rel="noopener noreferrer"
                className="text-dark-400 transition-colors hover:text-primary-400"
                aria-label="LinkedIn"
        ...
        <div className="mt-8 border-t border-dark-800 pt-8 text-center">
          <p className="font-mono text-sm text-dark-400">
            <span className="syntax-comment">// </span>© {currentYear} Nurul Faradila. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
